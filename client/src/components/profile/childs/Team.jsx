...
export default function Team() {
  return (
    <>
        <div className='w-full border-b-[1px] flex justify-between px-10 pt-10 pb-2 gap-8'>
                <div className='w-[40%]'>
                    <h3 className='text-xl font-bold'>Nitish kumar's Workspace</h3>
                    <p>A list of all the users in your Nitish kumar's Workspace.</p>
            ...
            <div>
                <div className='w-full flex justify-between px-10 pr-24 pt-4 pb-2 gap-8'>
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <div>
                            <h3>Nitish kumar</h3>
                            <h3 className='text-gray-500'>vciutcvuytfoiu6ydf@gmail.com</h3>
                        </div>
                    </div>
                    <h3>OWNER</h3>
                </div>
