  ...
  return (
    <>
        ...
        <div className='flex flex-col gap-3 justify-center items-center text-center'>
            <Heading_text text_size={"text-3xl mt-4 font-bold text-gray-800"} text={"Add a Website as Data Source"}/>
            ...
            <Input_field name={"url"} placeholder={"https://..."} style={"border-2 outline-main w-[45vw] pl-2 h-10 rounded-md"}/>
            ...
            <Heading_text text_size={"text-4xl mt-4 font-bold text-gray-800"} text={"Submit Sitemap"}/>
            ...
            <Input_field name={"sitemap"} placeholder={"https://..../sitemap.xml"} style={"border-2 outline-main w-[45vw] pl-2 h-10 rounded-md"}/>
