...
export default function Source_1_2_card() {
  ...
  return (
    <>
        <div className='flex gap-16 rounded-md ml-auto mr-auto justify-center items-center border-2 w-fit p-4'>
                <div className='flex justify-center items-center gap-4'>
                    ...
                    <div className={`${location.pathname==="/scrape" ? "text-gray-700":"text-main"}`}>
                        <h3>Add Website and Import Data</h3>
                    </div>
                </div>
                ...
                <div className='flex justify-center items-center gap-4'>
                    ...
                    <div>
                        <h3 className={`${location.pathname==="/scrape" ? "text-main":""}`}>Choose Pages and Train AI</h3>
                    </div>
                </div>
